// tourism-management-system/client/src/components/Home/Overview.jsx
import React from 'react';

const Overview = () => {
  return (
    <section className="py-16 bg-[#FFE3E1] text-center px-4"> {/* Using #FFE3E1 for background */}
      <div className="container mx-auto">
        <h2 className="text-4xl md:text-5xl font-extrabold text-[#FF9494] mb-8"> {/* Using #FF9494 for text */}
