...
//       <p>This page will allow admins to review and approve/reject tour guide applications.</p>
//     </div>
//   );
// };
...
// const ManageCandidatesAdmin = () => {
//     // We get user from AuthContext, needed for axiosSecure to implicitly get the token
...
//     const [isProcessing, setIsProcessing] = useState(false); // To prevent multiple actions at once

//     // Function to fetch all guide applications
//     const fetchApplications = useCallback(async () => {
//         setLoading(true);
//         setError(null);
//         if (!axiosSecure) { // Ensure axiosSecure is ready
//             setLoading(false);
//             return;
//         }
...
//     useEffect(() => {
//         fetchApplications();
//     }, [fetchApplications]); // Dependency on memoized fetchApplications
...
//                                         disabled // Placeholder for approve
//                                     >
//                                         Approve
//                                     </button>
//                                     <button
//                                         className="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600"
//                                         disabled // Placeholder for reject
//                                     >
//                                         Reject
//                                     </button>
//                                 </td>
...
const ManageCandidatesAdmin = () => {
    ...
    // --- New: Function to handle approving a candidate ---
    const handleApprove = async (applicationId, applicantEmail, applicantName) => {
        ...
        try {
            // Backend endpoint: PATCH /guide-applications/:id/approve
            ...
            if (response.status === 200) {
                ...
                fetchApplications(); // Re-fetch to update status in UI
            } else {
    ...
    // --- New: Function to handle rejecting a candidate ---
    const handleReject = async (applicationId, applicantName, applicantEmail) => {
        ...
        try {
            // Backend endpoint: PATCH /guide-applications/:id/reject
